...
////		CharacterEncodingFilter 클래스는 스프링에서 제공하는 클래스로 웹에서 주고받는 데이터의 헤더값을 UTF-8(지정한 문자)로 인코딩함
...
//	@SpringBootApplication(exclude= {MultipartAutoConfiguration.class}) 을 사용하여 중지된 자동 구성대신 사용하는 설정
	@Bean
